...
namespace SimpleWeb {
    ...
    public:
        Server(std::string address, unsigned short port, size_t num_threads, const std::string& cert_file, const std::string& private_key_file,
                size_t timeout_request=5, size_t timeout_content=300,
                const std::string& verify_file=std::string()) :
                ServerBase<HTTPS>::ServerBase(address, port, num_threads, timeout_request, timeout_content),
